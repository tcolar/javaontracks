    ...
    protected static Method lookForMethod(Object obj, String method, Object[] values) {
        ...
        if (m == null) {
            for (int i = 0; i != methods.length && m == null; i++) {
                ...
                if (tmpMethod.getName().equals(method) || tmpMethod.getName().equals(method2)) {
        ...
        if (JOTLogger.isWarningEnabled()) {
            ...
            params += "]";
            if (m == null) {
                JOTLogger.log(JOTLogger.CAT_FLOW, JOTLogger.WARNING_LEVEL, JOTView.class, "No such method: " + method + params);
            }
        }
        if (JOTLogger.isTraceEnabled()) {
            String params = "[";
            ...
            params += "]";
            if (m != null) {
                JOTLogger.log(JOTLogger.CAT_FLOW, JOTLogger.TRACE_LEVEL, JOTView.class, "Found mathing method: " + method + params);
            }
        }
        return m;
    }
